...
# IN operator returns True if the element on its left is in the sequence of his right
...
# NOT IN returns True if the element on its left is not in sequence on its right
print("\n-------- NOT IN --------")
