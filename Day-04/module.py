...
'''
    ...
    etc etc ...
'''
# to use module we have to import in the file/script in which we want to work with like below : 
import random

# we can specify which function/variable/class we want to use from module like below :
